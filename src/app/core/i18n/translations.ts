...
export const TRANSLATIONS = {
  en: {
    ...
    'commission.placeholder': 'Enter commission percentage',
    ...
    'hotelDetails.editHotelCommission': 'Edit Hotel Comm.',
    'hotelDetails.allStatus': 'All Status',
    'hotelDetails.tripTableLabel': 'Hotel integration trips table',
    'hotelDetails.hotelsTableLabel': 'All hotels table',
    'hotelDetails.selectAllHotels': 'Select all hotels',
    'hotelDetails.selectHotel': 'Select',
    'hotelDetails.hotelFallback': 'hotel',
    'hotelDetails.openHotelActions': 'Open hotel actions',
    'hotelDetails.viewHotelInfo': 'View Hotel Info',
    'hotelDetails.settleBalance': 'Settle Balance',
    'hotelDetails.blockHotel': 'Block Hotel',
    'hotelDetails.unblockHotel': 'Unblock Hotel',
    'hotelDetails.statusActive': 'Active',
    'hotelDetails.statusSuspended': 'Suspended',
    'hotelDetails.commissionsPlural': 'Hotels Commissions',
    'hotelDetails.commissionSingle': 'Hotel Commission',
    'hotelDetails.selectedHotels': 'Selected Hotels',
    'hotelDetails.removeHotel': 'Remove',
    'hotelDetails.selectedCommissionLabel': 'General Commission for selected Hotels (%)',
    'hotelDetails.saveChanges': 'Save Changes',
  ...
  ar: {
      ...
      'commission.placeholder': 'أدخل نسبة العمولة',
    ...
    'hotelDetails.editHotelCommission': 'تعديل عمولة الفندق',
    'hotelDetails.allStatus': 'كل الحالات',
    'hotelDetails.tripTableLabel': 'جدول رحلات تكامل الفنادق',
    'hotelDetails.hotelsTableLabel': 'جدول كل الفنادق',
    'hotelDetails.selectAllHotels': 'تحديد كل الفنادق',
    'hotelDetails.selectHotel': 'تحديد',
    'hotelDetails.hotelFallback': 'فندق',
    'hotelDetails.openHotelActions': 'فتح إجراءات الفندق',
    'hotelDetails.viewHotelInfo': 'عرض معلومات الفندق',
    'hotelDetails.settleBalance': 'تسوية الرصيد',
    'hotelDetails.blockHotel': 'حظر الفندق',
    'hotelDetails.unblockHotel': 'إلغاء حظر الفندق',
    'hotelDetails.statusActive': 'نشط',
    'hotelDetails.statusSuspended': 'موقوف',
    'hotelDetails.commissionsPlural': 'عمولات الفنادق',
    'hotelDetails.commissionSingle': 'عمولة الفندق',
    'hotelDetails.selectedHotels': 'الفنادق المحددة',
    'hotelDetails.removeHotel': 'إزالة',
    'hotelDetails.selectedCommissionLabel': 'العمولة العامة للفنادق المحددة (%)',
    'hotelDetails.saveChanges': 'حفظ التغييرات',
  ...
  de: {
    ...
    'hotel.commission': 'Hotelprovisionen',
      'commission.info': 'Jede Aktualisierung der Hotelprovision wird ab 00:00 Uhr am Tag der Aktualisierung in den Konten berücksichtigt.',
      'commission.placeholder': 'Provisionsprozentsatz eingeben',
      'commission.percentage': 'Provisionsprozentsatz',
      'commission.value': 'Provisionswert',
     'hotelDetails.titlemain': 'Hotel Details',
    // ── Navbar ────────────────────────────────────────────────────────────
    'nav.signIn': 'Anmelden',
    ...
    'hotelDetails.editHotelCommission': 'Hotelprovision bearbeiten',
    'hotelDetails.allStatus': 'Alle Status',
    'hotelDetails.tripTableLabel': 'Tabelle der Hotel-Integrationsfahrten',
    'hotelDetails.hotelsTableLabel': 'Tabelle aller Hotels',
    'hotelDetails.selectAllHotels': 'Alle Hotels auswählen',
    'hotelDetails.selectHotel': 'Auswählen',
    'hotelDetails.hotelFallback': 'Hotel',
    'hotelDetails.openHotelActions': 'Hotelaktionen öffnen',
    'hotelDetails.viewHotelInfo': 'Hotelinformationen anzeigen',
    'hotelDetails.settleBalance': 'Saldo abrechnen',
    'hotelDetails.blockHotel': 'Hotel sperren',
    'hotelDetails.unblockHotel': 'Hotel entsperren',
    'hotelDetails.statusActive': 'Aktiv',
    'hotelDetails.statusSuspended': 'Gesperrt',
    'hotelDetails.commissionsPlural': 'Hotelprovisionen',
    'hotelDetails.commissionSingle': 'Hotelprovision',
    'hotelDetails.selectedHotels': 'Ausgewählte Hotels',
    'hotelDetails.removeHotel': 'Entfernen',
    'hotelDetails.selectedCommissionLabel': 'Allgemeine Provision für ausgewählte Hotels (%)',
    'hotelDetails.saveChanges': 'Änderungen speichern',
