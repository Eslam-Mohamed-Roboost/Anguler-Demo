...
export const TRANSLATIONS = {
  en: {
    ...
    'tripDetails.hotelProfitWithRate': 'Hotel Profit (CHF) * 10% =',
  ...
  ar: {
    ...
    'tripDetails.hotelProfitWithRate': 'ربح الفندق (CHF) * 10% =',
  ...
  de: {
    ...
    'tripDetails.hotelProfitWithRate': 'Hotelgewinn (CHF) * 10% =',
