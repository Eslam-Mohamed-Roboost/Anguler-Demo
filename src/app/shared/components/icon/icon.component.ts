...
const ICON_PATHS: Record<string, string[]> = {
  ...
  phone: [
    'M2.25 6.338c0-1.243 1.008-2.25 2.25-2.25h1.136a.75.75 0 0 1 .713.514l1.28 3.84a.75.75 0 0 1-.27.828l-1.034.776a11.264 11.264 0 0 0 5.65 5.65l.776-1.034a.75.75 0 0 1 .828-.27l3.84 1.28a.75.75 0 0 1 .514.713v1.136a2.25 2.25 0 0 1-2.25 2.25H17.25C9.516 19.5 2.25 12.234 2.25 4.5v-.162A2.25 2.25 0 0 1 2.25 6.338Z',
  ],
  mail: [
  ...
  car: [
    'M8 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm8 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z',
    'M5.2 14h13.6M6.6 7h10.8l2.1 4.5H4.5L6.6 7zM4 14.5v3a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5V16m10 0v1.5a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5v-3',
  ],
  'dollar-sign': [
    'M12 1v22',
